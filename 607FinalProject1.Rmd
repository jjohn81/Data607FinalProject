...
```{r}
colnames(congress_by_party)<-c("Year","Senate_Dem","Senate_Rep","Senate_Oth","House Dem","House Rep","House Oth","State Legislatures Dem","State Legislatures Rep","State Legislatures Split+NE")
congress_by_party<-congress_by_party[-3,]
congress_by_party %>% kable() %>% kable_styling() %>% scroll_box(height = "400px")
```
